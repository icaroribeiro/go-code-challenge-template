...
import (
	...
	auth "github.com/icaroribeiro/new-go-code-challenge-template/internal/core/domain/model"
...
func (_m *MockAuth) CreateToken(_a0 auth.Auth, tokenExpTimeInSec int) (string, error) {
...
func (_m *MockAuth) FetchAuthFromToken(token *jwt.Token) (auth.Auth, error) {
	ret := _m.Called(token)
