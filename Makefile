...
test-api:
	...
	go test ./internal/... -v -coverprofile=./docs/rest-api/tests/unit/coverage.out && go tool cover -func=./docs/rest-api/tests/unit/coverage.out > ./docs/rest-api/tests/unit/coverage_report.out; \
	go test ./tests/rest-api/... -v -coverprofile=./docs/rest-api/tests/integration/coverage.out && go tool cover -func=./docs/rest-api/tests/integration/coverage.out > ./docs/rest-api/tests/integration/coverage_report.out
